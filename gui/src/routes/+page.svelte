<script lang="ts">
	import SliderSales from '../components/SliderSales/SliderSales.svelte';
...
<main>
	...
	<div class="content">
		...
		<Form theme={'Другие вопросы'} question={'Ваш вопрос'} />
	</div>
</main>
...
<style lang="scss">
	...
	.teaPic {
		background: linear-gradient(to top, #d7a84e, #f3e7bc);
		border-radius: 30px;
		padding: 20px 20px;
		margin-bottom: 18px;
